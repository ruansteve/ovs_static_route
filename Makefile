...
am__append_30 = utilities/ovs-vlan-bug-workaround
am__append_31 = utilities/nlmon
am__append_32 = utilities/bugtool/ovs-bugtool
am__append_33 = utilities/bugtool/ovs-bugtool
am__append_34 = utilities/bugtool/ovs-bugtool.8
am__append_35 = utilities/bugtool/ovs-bugtool.8.in
am__append_36 = utilities/bugtool/ovs-bugtool.8
am__append_37 = $(bugtool_scripts)
am__append_38 = bugtool-install-data-local
am__append_39 = bugtool-uninstall-local
#am__append_40 = tests/test-dpdkr
am__append_41 = \
...
am__append_43 = $(TESTPKI_FILES)
am__append_44 = $(TESTPKI_FILES) tests/ovs-pki.log
am__append_45 = clean-pki
am__append_46 = .h .hstamp
am__append_47 = $(HSTAMP_FILES)
am__append_48 = $(HSTAMP_FILES)
#am__append_49 = vswitchd/vswitch.gv vswitchd/vswitch.pic
#am__append_50 = vtep/vtep.gv vtep/vtep.pic
#am__append_51 = $(srcdir)/datapath-windows/include/OvsDpInterface.h
#am__append_52 = ovn/ovn-sb.gv ovn/ovn-sb.pic
#am__append_53 = ovn/ovn-nb.gv ovn/ovn-nb.pic
subdir = .
...
am__lib_libopenvswitch_la_SOURCES_DIST = lib/aes128.c lib/aes128.h \
	...
	lib/reconnect.c lib/reconnect.h lib/rstp.c lib/rstp.h \
	lib/rstp-common.h lib/rstp-state-machines.c \
	lib/rstp-state-machines.h lib/sat-math.h lib/seq.c lib/seq.h \
	lib/sha1.c lib/sha1.h lib/shash.c lib/shash.h lib/simap.c \
	lib/simap.h lib/smap.c lib/smap.h lib/socket-util.c \
...
am_lib_libopenvswitch_la_OBJECTS = lib/aes128.lo lib/backtrace.lo \
	...
	lib/ovsdb-idl.lo lib/ovsdb-parser.lo lib/ovsdb-types.lo \
	lib/packets.lo lib/pcap-file.lo lib/perf-counter.lo \
	lib/pktbuf.lo lib/poll-loop.lo lib/process.lo lib/pvector.lo \
	lib/random.lo lib/rconn.lo lib/reconnect.lo lib/rstp.lo \
...
am__noinst_HEADERS_DIST = CONTRIBUTING.md CodingStyle.md DESIGN.md \
	...
	.travis.yml .travis/linux-build.sh .travis/linux-prepare.sh \
	...
	lib/db-ctl-base.xml lib/vswitch-idl.ann \
	...
	utilities/ovs-sim.in utilities/ovs-sim.1.xml \
	...
	debian/ovn-common.install debian/ovn-common.manpages \
	debian/ovn-docker.install debian/ovn-host.dirs \
	debian/ovn-host.init debian/ovn-host.install \
	debian/ovn-host.manpages debian/ovn-host.postinst \
	debian/ovn-host.postrm debian/ovn-host.template \
	debian/ovs-monitor-ipsec debian/python-openvswitch.dirs \
	...
	tutorial/ovn/env7/packet1.sh tutorial/ovn/env7/packet2.sh \
	tutorial/ovn/env7/setup.sh vtep/vtep-idl.ann vtep/ovs-vtep \
...
ACLOCAL = ${SHELL} /home/steve/submit/ovs/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /home/steve/submit/ovs/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/steve/submit/ovs/build-aux/missing autoheader
AUTOM4TE = ${SHELL} /home/steve/submit/ovs/build-aux/missing autom4te
AUTOMAKE = ${SHELL} /home/steve/submit/ovs/build-aux/missing automake-1.15
AWK = gawk
CAPNG_LDADD = 
...
KARCH = 
KBUILD = /lib/modules/4.2.0-16-generic/build
...
LT_CURRENT = 1
LT_REVISION = 0
MAKEINFO = ${SHELL} /home/steve/submit/ovs/build-aux/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
MSVC64_LDFLAGS = 
MSVC_CFLAGS = 
...
abs_builddir = /home/steve/submit/ovs
abs_srcdir = /home/steve/submit/ovs
abs_top_builddir = /home/steve/submit/ovs
abs_top_srcdir = /home/steve/submit/ovs
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/steve/submit/ovs/build-aux/install-sh
...
ALL_LOCAL = $(am__append_6) config-h-check printf-check static-check \
	...
	$(am__append_48) check-debian-changelog-version \
...
CLEANFILES = $(am__append_7) $(am__append_9) flake8-check \
	...
	ofproto/ipfix-entities.def $(am__append_33) \
	$(valgrind_wrappers) $(am__append_44) include/odp-netlink.h \
	$(am__append_47) vswitchd/vswitch.ovsschema.stamp \
...
CLEAN_LOCAL = clean-pycov $(am__append_12) clean-lcov $(am__append_45)
DISTCLEANFILES = utilities/ovs-appctl.8 utilities/ovs-ctl \
	...
	utilities/ovs-vsctl.8 $(am__append_36) tests/atconfig \
	tests/atlocal debian/copyright vswitchd/ovs-vswitchd.8 \
	$(am__append_49) vswitchd/ovs-vswitchd.conf.db.5 \
	ovsdb/ovsdb-tool.1 ovsdb/ovsdb-client.1 ovsdb/ovsdb-server.1 \
	ovsdb/ovsdb-idlc ovsdb/ovsdb-dot vtep/vtep-ctl.8 \
	$(am__append_50) vtep/vtep.5 $(am__append_52) ovn/ovn-sb.5 \
	$(am__append_53) ovn/ovn-nb.5 ovn/ovn-architecture.7 \
...
docs = CONTRIBUTING.md CodingStyle.md DESIGN.md FAQ.md INSTALL.md \
	...
	TODO.md WHY-OVS.md Documentation/committer-responsibilities.md \
	Documentation/committer-grant-revocation.md \
	Documentation/group-selection-method-property.txt \
	utilities/ovs-command-bashcomp.INSTALL.md \
	third-party/README.md tutorial/Tutorial.md \
...
# Docker drivers
bin_SCRIPTS = utilities/ovs-docker utilities/ovs-pki $(am__append_29) \
	ovn/utilities/ovn-docker-overlay-driver \
	ovn/utilities/ovn-docker-underlay-driver
...
dist_scripts_DATA = 
INSTALL_DATA_LOCAL = lib-install-data-local $(am__append_38)
UNINSTALL_LOCAL = $(am__append_39) ovs-uninstall-local
# ovsdb-tool.1
# ovsdb-client.1
# ovsdb-server.1
man_MANS = utilities/ovs-appctl.8 utilities/ovs-ctl.8 \
	...
	utilities/ovs-vsctl.8 $(am__append_34) vswitchd/ovs-vswitchd.8 \
...
MAN_ROOTS = utilities/ovs-appctl.8.in \
	...
	utilities/ovs-vlan-bug-workaround.8.in utilities/ovs-test.8.in \
	utilities/ovs-vlan-test.8.in utilities/ovs-vsctl.8.in \
	$(am__append_35) vswitchd/ovs-vswitchd.8.in \
	ovsdb/ovsdb-tool.1.in ovsdb/ovsdb-client.1.in \
	ovsdb/ovsdb-server.1.in ovsdb/ovsdb-idlc.1 vtep/vtep-ctl.8.in \
...
sbin_SCRIPTS = $(am__append_32)

# ovs-vtep
scripts_SCRIPTS = utilities/ovs-check-dead-ifs utilities/ovs-ctl \
	utilities/ovs-save $(am__append_37) vtep/ovs-vtep \
	ovn/utilities/ovn-ctl
completion_SCRIPTS = utilities/ovs-appctl-bashcomp.bash \
	utilities/ovs-vsctl-bashcomp.bash
scripts_DATA = utilities/ovs-lib
SUFFIXES = .in .xml $(am__append_46) .ovsidl .ovsschema
check_DATA = $(am__append_43)
...
FLAKE8_PYFILES = ofproto/ipfix-gen-entities utilities/ovs-pcap.in \
	$(CHECK_PYFILES) debian/ovs-monitor-ipsec \
	xenserver/usr_share_openvswitch_scripts_ovs-xapi-sync \
...
lib_libopenvswitch_la_SOURCES = lib/aes128.c lib/aes128.h \
	...
	lib/lldp/lldp-const.h lib/lldp/lldp-tlv.h lib/lldp/lldpd.c \
	lib/lldp/lldpd.h lib/lldp/lldpd-structs.c \
	lib/lldp/lldpd-structs.h $(am__append_14) $(am__append_15) \
...
nodist_lib_libopenvswitch_la_SOURCES = lib/dirs.c lib/vswitch-idl.c \
	lib/vswitch-idl.h $(am__append_26)
...
ofproto_libofproto_la_SOURCES = ofproto/bond.c ofproto/bond.h \
	...
	ofproto/pinsched.c ofproto/pinsched.h ofproto/tunnel.c \
	ofproto/tunnel.h ofproto/bundles.c ofproto/bundles.h \
	ofproto/ipfix-entities.def
ofproto_libofproto_la_CPPFLAGS = $(AM_CPPFLAGS)
ofproto_libofproto_la_CFLAGS = $(AM_CFLAGS)
ofproto_libofproto_la_LIBADD = lib/libsflow.la $(am__append_28)
...
$(srcdir)/manpages.mk $(srcdir)/Documentation/automake.mk $(srcdir)/m4/automake.mk $(srcdir)/lib/automake.mk $(srcdir)/ofproto/automake.mk $(srcdir)/utilities/automake.mk $(srcdir)/utilities/bugtool/automake.mk $(srcdir)/tests/automake.mk $(srcdir)/include/automake.mk $(srcdir)/include/openflow/automake.mk $(srcdir)/include/openvswitch/automake.mk $(srcdir)/include/sparse/automake.mk $(srcdir)/include/windows/automake.mk $(srcdir)/third-party/automake.mk $(srcdir)/debian/automake.mk $(srcdir)/vswitchd/automake.mk $(srcdir)/ovsdb/automake.mk $(srcdir)/rhel/automake.mk $(srcdir)/xenserver/automake.mk $(srcdir)/python/automake.mk $(srcdir)/tutorial/automake.mk $(srcdir)/vtep/automake.mk $(srcdir)/datapath-windows/automake.mk $(srcdir)/datapath-windows/include/automake.mk $(srcdir)/windows/automake.mk $(srcdir)/ovn/automake.mk $(srcdir)/ovn/controller/automake.mk $(srcdir)/ovn/controller-vtep/automake.mk $(srcdir)/ovn/lib/automake.mk $(srcdir)/ovn/northd/automake.mk $(srcdir)/ovn/utilities/automake.mk $(srcdir)/ovn/utilities/bugtool/automake.mk $(srcdir)/selinux/automake.mk $(am__empty):
